...
-- --------------------------------------------------
-- Date Created: 03/18/2018 15:17:46
-- Generated from EDMX file: C:\Users\Maria\Desktop\Куросовая\Cinema\Cinema\CinemaModel.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_CinemaСashier]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[СashierSet] DROP CONSTRAINT [FK_CinemaСashier];
GO
...
GO
IF OBJECT_ID(N'[dbo].[СashierSet]', 'U') IS NOT NULL
    DROP TABLE [dbo].[СashierSet];
GO
